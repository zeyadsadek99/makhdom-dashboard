  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import("@/views/company/cancel-reasons/Home.vue"),
          children: [
            {
              path: "",
              name: "cancel-reasons",
              meta: {
                auth: true,
                permission: ["cancel_reasons", "index"],
              },
              component: () =>
                import("@/views/company/cancel-reasons/index.vue"),
            },

            {
              path: "form/:id",
              props: true,
              name: "edit-cancel-reason",
              meta: {
                auth: true,
                permission: ["cancel_reasons", "store"],
              },
              component: () =>
                import("@/views/company/cancel-reasons/Form.vue"),
            },
            {
              path: "form",
              props: true,
              name: "add-cancel-reason",
              meta: {
                auth: true,
                permission: ["cancel_reasons", "update"],
              },
              component: () =>
                import("@/views/company/cancel-reasons/Form.vue"),
            },
