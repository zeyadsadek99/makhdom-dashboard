<template>
  <div class="h-full flex flex-col">
    <breadcrumbs :items="breadItems" :title="$t('LABELS.statistics')" />
    <div
    ...
    >
      <!-- <base-filter
        name="statistics"
        :inputs="[]"
        :btn-name="t(`BUTTONS.add`, { name: t('LABELS.statistics') })"
        icon="fas fa-plus"
        :keyword="true"
        @action="$router.push('/statistics/form')"
      /> -->
      ...
      >
          ...
          >
            ...
            <div class="flex items-center justify-center mt-7 gap-2 flex-wrap">
              ...
              >
                ...
                {{ $t(`BUTTONS.add`, { name: $t("LABELS.statistics") }) }}
              </router-link>
            </div>
          </div>
        ...
        <!-- <template v-slot:[`item.actions`]="{ item, index }">
          <div class="flex items-center gap-4">
            <router-link :to="`/faq/form/${item.id}`">
...
const headers = [
  {
    title: t("LABELS.Name", { name: t("LABELS.Client") }),
    align: "start",
    sortable: false,
    key: "client",
  },
  // {
  //   title: t("LABELS.Name", { name: t("LABELS.order") }),
  //   align: "start",
  //   sortable: false,
  //   key: "order",
  // },
  // {
  //   title: t("LABELS.Name", { name: t("LABELS.order_cancelled") }),
  //   align: "start",
  //   sortable: false,
  //   key: "order_cancelled",
  // },
  // {
  //   title: t("LABELS.Name", { name: t("LABELS.order_cancelled_by_client") }),
  //   align: "start",
  //   sortable: false,
  //   key: "order_cancelled_by_client",
  // },
  // {
  //   title: t("LABELS.Name", { name: t("LABELS.order_cancelled_by_vendor") }),
  //   align: "start",
  //   sortable: false,
  //   key: "order_cancelled_by_vendor",
  // },
  // {
  //   title: t("LABELS.Name", { name: t("LABELS.refund_order") }),
  //   align: "start",
  //   sortable: false,
  //   key: "refund_order",
  // },
