  ...
  <div>
    ...
    <div class="flex gap-4 flex-wrap">
      <div class="flex-1 w-full min-w-[250px]">
        ...
        <template v-else>
          <base-card1
            :title="$t('TITLES.Details', { name: $t('LABELS.Wholesaler') })"
          >
            <VeeForm
            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <base-select
                  ...
                  :url="GENERAL_URL + '/general/facility-types?type=provider'"
                  :filter="null"
                  :multiple="false"
                ...
                <base-input
                  id="emailAddress"
                  name="emailAddress"
                  :placeholder="$t('LABELS.FacilityEmail')"
                  :label="$t('LABELS.FacilityEmail')"
                  icon="envelope"
                />
                <base-input
                  id="whatsapp"
                ...
                <base-input
                  id="phone"
                  name="phone"
                  :placeholder="t('LABELS.FacilityPhone')"
                  :label="t('LABELS.FacilityPhone')"
                  icon="phone"
                />
              </div>
...
const breads = [
  ...
  },
  {
    ...
    path: `/wholesalers/form${route.params.id ? "/" + route.params.id : ""}`,
  },
];

function getData() {
  axios.get(`providers/${route.params.id}`).then((res) => {
