  ...
  <base-card1>
    ...
    <ul class="top-header">
      ...
      <li>
        ...
        <p class="value">{{ item.provider.full_name }}</p>
      </li>
      <li v-if="item.provider?.email">
    ...
    <ul class="top-header address">
      <li>
        ...
        <p class="value">{{ item.address?.address ?? "-" }}</p>
      </li>
      ...
      <li v-if="item.address">
        <a
          ...
          },&destination=${item.address.lat},${item.address.lng}`"
          class="location"
        >
